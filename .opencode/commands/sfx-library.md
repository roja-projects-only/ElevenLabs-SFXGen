...
1. **Per-category counts** — how many SFX exist in each category folder: `ambience`, `stinger`, `transition`, `background_music`, `foley`, `jingle`, `news`, `misc`. Show a small table.
